...
class Email extends \AddressBookBundle\Entity\Email implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AddressBookBundle\\Entity\\Email' . "\0" . 'persons', '' . "\0" . 'AddressBookBundle\\Entity\\Email' . "\0" . 'id', '' . "\0" . 'AddressBookBundle\\Entity\\Email' . "\0" . 'emailAddress', '' . "\0" . 'AddressBookBundle\\Entity\\Email' . "\0" . 'emailType');
        }
